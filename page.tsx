...
const plans = [
  {
    ...
    price: "99.000đ",
    cadence: "/ tháng",
    description: "Khởi đầu tiết kiệm cho nhu cầu cơ bản.",
    features: ["01 tài khoản", "Tối đa 80 thửa mỗi lượt", "40% bộ công cụ", "Nâng cấp bất kỳ lúc nào"],
    action: "Chọn gói Go",
    featured: false,
  },
  {
    ...
    price: "199.000đ",
    cadence: "/ tháng",
    description: "Cân bằng chi phí và công cụ cho chuyên viên.",
    features: ["01 tài khoản", "Tối đa 140 thửa mỗi lượt", "70% bộ công cụ", "Word, PDF và Excel nâng cao"],
    action: "Chọn gói Plus",
    featured: true,
  },
  {
    name: "Pro",
    price: "399.000đ",
    cadence: "/ tháng",
    description: "Đầy đủ công cụ cho người dùng chuyên nghiệp.",
    features: ["01 tài khoản", "Tối đa 200 thửa mỗi lượt", "100% bộ công cụ", "OCR và so sánh nâng cao"],
    action: "Chọn gói Pro",
    featured: false,
  },
  {
    name: "Văn phòng",
    price: "298.000đ",
    cadence: "/ tài khoản/tháng",
    description: "Tùy chọn số lượng cho tổ, nhóm và đơn vị.",
    features: ["2–4 tài khoản: quyền Plus", "Từ 5 tài khoản: đầy đủ công cụ", "Từ 5 tài khoản: không giới hạn/lượt", "Quản lý bản quyền theo số lượng mua"],
    action: "Chọn số tài khoản",
    featured: false,
  },
];
