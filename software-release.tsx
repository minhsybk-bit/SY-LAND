...
const FALLBACK: GithubRelease = {
  tag_name: "v11.1.0",
  name: "SỸ LAND 11.1.0",
  html_url: "https://github.com/minhsybk-bit/SY-LAND/releases/tag/v11.1.0",
  published_at: "2026-07-18T00:00:00Z",
  assets: [{ name: "SYLAND_Setup_11.1.0.exe", size: 136930454, browser_download_url: "https://github.com/minhsybk-bit/SY-LAND/releases/download/v11.1.0/SYLAND_Setup_11.1.0.exe", digest: "sha256:4824661861d65c03a754af45f7cc9cf937f0ca5f9511017d8acd44b05a843a71" }],
};
...
export default function SoftwareRelease() {
  ...
  const checksum = installer.digest?.replace(/^sha256:/i, "") || (version === "11.1.0" ? FALLBACK.assets[0].digest!.replace("sha256:", "") : "Xem tại trang phát hành GitHub");
